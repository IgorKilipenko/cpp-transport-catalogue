...
void TestFindNameByPrefix() {
    ...
    assert(
        get_names(book.FindByNamePrefix("Vas"sv)) ==
        (vector<string>{"Vasilisa Kuznetsova"s, "Vasiliy Ivanov"s, "Vasiliy Petrov"s, "Vassisualiy Lokhankin"s}));
    assert(get_names(book.FindByNamePrefix("Vasili"sv)) == (vector<string>{"Vasilisa Kuznetsova"s, "Vasiliy Ivanov"s, "Vasiliy Petrov"s}));
    ...
    assert(
        get_names(book.FindByNamePrefix(""sv)) == (vector<string>{
                                                      ""s, "Ivan Ivanov"s, "Ivan Petrov"s, "Ivan Vasiliev"s, "Vasilisa Kuznetsova"s,
