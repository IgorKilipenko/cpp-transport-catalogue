...
namespace shapes {
    ...
    inline svg::Polyline CreateStar(svg::Point center, double outer_rad, double inner_rad, int num_rays) {
        using namespace svg;
        Polyline polyline;
...
namespace svg::tests {
    ...
    public:
        ...
        void TestSvglib() {
            BaseTester base_tester;
            ShapeTester shape_tester;
            ...
            std::cerr << std::endl << "All SVG Tests : Done." << std::endl << std::endl;
        }
    };
}
